...
const getOrdersWhereTotalIsOver = (req,res) => {
    console.log('OrdersController.getOrdersWhereTotalIsOver');
    db.getOrdersWhereTotalIsOver({
...
const getOrdersWhereIsThisItem = (req,res) => {
    console.log('OrdersController.getOrdersWhereIsThisItem');
    db.getOrdersWhereIsThisItem({
        id: req.params.id
    }, function (err, result) {
        if (err) {
            console.log('An error has ocurred: ' + err);
